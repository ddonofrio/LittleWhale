...
import { joinContextSections, renderContextSections, renderPrompt } from '@ddonofrio/littlewhale'
import type { PromptAssembly } from '@ddonofrio/littlewhale'
import type { CompactionEngine } from '@deepseek-ai/dsh-compaction'
import type { Context } from '@deepseek-ai/cordis'
import { RuntimeContextProjection } from './runtime-context.ts'
import { executeToolCalls } from './tool-calls.ts'
import { detectTokenLoop, loopTextForChunk, tokenizeLoopText, type LoopDetectionStreamSelection } from './loop-detector.ts'
  ...
  private async step(assembly: PromptAssembly): Promise<StepEndReason | null> {
    ...
    while (true) {
      ...
      try {
        ...
        const selection: LoopDetectionStreamSelection = {
          text: this.loopDetection.detectOnText,
          reasoning: this.loopDetection.detectOnReasoning,
          toolCall: this.loopDetection.detectOnToolCall,
        }
