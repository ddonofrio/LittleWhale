...
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@ddonofrio/littlewhale'
import type { Config, PromptAssembly } from '@ddonofrio/littlewhale'
