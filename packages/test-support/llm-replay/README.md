...
Its consumers are the ACP, headless `stream-json`, and assembled Web snapshot suites. Loader-driven suites mount this plugin in place of a real LLM adapter; the Web snapshot scaffold installs it directly to retain the teardown consumption handle.
