...
import { en as conversationEn, zh } from '@deepseek-ai/dsh-client-ui-conversation/src/client/locales.ts'
...
const enT: GenericToolCardProps['t'] = makeTranslate(conversationEn, commonEn)
...
describe('ReadRow keyed toolview', () => {
  ...
  it('renders English read labels from the conversation locale', () => {
    const view = render(<ReadRow {...{ ...rowProps(settled()), t: enT }} />)
    toggleRow(view)
