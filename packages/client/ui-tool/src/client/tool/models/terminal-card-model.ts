...
import type {
  ReadBlockLabels, TerminalBlockLabels, TerminalBlockProps,
...
/**
 * Build the ReadBlock display copy from the conversation locale seat, shared by
 * the chat row and the details panel.
 * @param t - the render site's conversation locale seat.
 * @returns the full label set for {@link ReadBlockLabels}.
 */
