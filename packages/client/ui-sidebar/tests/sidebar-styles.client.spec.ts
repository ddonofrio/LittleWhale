...
describe('SidebarRoot.module.css', () => {
  ...
  it('keeps the slotted brand row at the full artwork height', () => {
    ...
    expect(declarations('.brandIdentity')?.get('gap')).toBe('0')
    expect(declarations('.brandName')?.get('height')).toBe('48px')
    expect(declarations('.brandName')?.get('line-height')).toBe('48px')
    expect(declarations('.brandName')?.get('font-size')).toBe('36px')
    expect(declarations('.brandName')?.get('margin-left')).toBe('-32px')
    expect(declarations('.fallbackBrandName')?.get('font-size')).toBe('34px')
