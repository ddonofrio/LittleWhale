// Hero chrome for the blank-draft phase of ConversationRoot: centered brand
// mark,
...
/**
 * Render the hero chrome (brand mark only; no glow, no composer, no workspace
...
export function HeroShell({ renderSlot, children }: HeroShellProps) {
  return (
    <div className={css.root} data-hero-chrome="">
      <div className={css.stack}>
        <div className={css.headline}>
          {/* The combined Little Whale hero mark is centered at the requested size. */}
          <span className={css.fishHitbox}>
            {renderSlot('conversation.hero.brand.mark', { size: 136, className: css.fish }, {
              fallback: <img src="/little-whale-logo-text.png" width={390} height={136} className={css.fish} alt="Little Whale" />,
            })}
          </span>
        </div>
