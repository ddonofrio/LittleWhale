...
export const zh = {
  ...
  'context.compactAt': 'Compact at',
  'context.compactAtAria': 'Automatic compaction position',
  'context.apply': 'Apply',
  'context.useGlobal': 'Use global value',
  ...
  'settings.compaction.title': 'Automatic compaction position',
  'settings.compaction.description': 'Context-window percentage used when an LLM has no individual setting',
  'settings.compaction.aria': 'Global automatic compaction position',
