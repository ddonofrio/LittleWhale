...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  loopDetectionDetectOn: 'Detect on',
  loopDetectionDetectOnText: 'Text output',
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  loopDetectionDetectOn: '检测来源',
  loopDetectionDetectOnText: '文本输出',
  loopDetectionDetectOnReasoning: '推理',
  loopDetectionDetectOnToolCall: '工具调用',
  loopDetectionDetectOnHint: '至少必须保留一个流处于选中状态。',
