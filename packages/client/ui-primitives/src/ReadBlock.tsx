...
export interface ReadBlockProps {
  ...
  /** Localized labels; omitted fields keep the built-in defaults. */
  labels?: Partial<ReadBlockLabels> | undefined
  /** Extra class merged onto the wrapper (callers position; this component draws). */
  className?: string | undefined
}

/** Display copy for the read surface's banner and height-cap control. */
export interface ReadBlockLabels {
  /** Window-count note, given the number of returned and total file lines. */
