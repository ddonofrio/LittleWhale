/** English copy dictionaries for the Models settings section. */

import { WELCOME_NOTICE_COPY } from '../onboarding-copy.ts'

/** English strings for the Models page and its behavior tab. */
export const en = {
  nav: 'Models',
  title: 'Models',
  intro: 'Connect a local or LAN OpenAI-compatible model server. The endpoint and model list are editable below.',
  tabs: 'Model views',
  modelListTab: 'List',
  behaviorTab: 'Behavior',
  empty: 'No model settings are available.',
  edit: 'Edit',
  ...
  onboardingTitle: 'Connect a local model server',
  onboardingDescription: 'Set the OpenAI-compatible endpoint, discover its models, and choose a default model to start building.',
