...
import SystemPrompt, { type Config as SystemPromptConfig } from '@ddonofrio/littlewhale'
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** Little Whale home directory shared by shell context and local skill discovery. */
  dshHome?: string
