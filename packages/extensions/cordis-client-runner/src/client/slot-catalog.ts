...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  {
    key: 'conversation.hero.access',
    kind: 'single',
    scope: 'session',
    summary: 'Current-session access selector displayed beside the hero workspace and mode controls.',
    doc: 'Current-session access selector displayed beside the hero workspace and mode controls.',
    registerOptions: [],
    ownerProps: [],
    ownerPropsReferences: [],
    standardProps: [
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation HeroPermissionSelect',
    ],
    replaceRisk: 'shadows-shipped-ui',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'conversation.hero.access\', () => ctx.slots.register(\n      { name: \'conversation.hero.access\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'Centered brand mark on the blank-session hero.',
    doc: 'Centered brand mark on the blank-session hero. Declared by this\npackage\'s `conversation` entry; the shell supplies a whale fallback.',
    registerOptions: [],
    ownerProps: [
    ...
    occupants: [
      ...
      '@little-whale/ui-brand LittleWhaleHeroMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    declaredBy: 'an entry in \'conversation\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-goal AutomationChip id \'auto-goal\'',
      'client-ui-goal AutomationChip id \'auto-todos\'',
      'client-ui-settings-plugins MasterChip id \'master-model\'',
    ],
    replaceRisk: 'none',
  ...
  {
    key: 'conversation.input.masterModel',
    kind: 'single',
    scope: 'session',
    summary: 'Master-model selector immediately before the student model selector.',
    doc: 'Master-model selector immediately before the student model selector.',
    registerOptions: [],
    ownerProps: [
    ...
    declaredBy: 'an entry in \'conversation.composer.bar\' (client-ui-conversation), so it exists while that entry is mounted',
    occupants: [
      'client-ui-settings-plugins MasterModelSelect',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  {
    key: 'settings.models.item',
    kind: 'list',
    scope: 'root',
    summary: 'One behavior preference row inside the Models Behavior tab.',
    doc: 'One behavior preference row inside the Models Behavior tab.',
    registerOptions: [
      {
        name: 'id',
        requirement: 'required',
    ...
    hookContext: '',
    slotInject: '',
    declaredBy: 'an entry in \'settings.models.tab\' (client-ui-settings-models), so it exists while that entry is mounted',
    occupants: [
      'client-ui-conversation CompactionPolicyRow id \'compaction-policy\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-settings-models ModelsSection id \'model-list\'',
      'client-ui-settings-models ModelsBehaviorTab id \'behavior\'',
    ],
    replaceRisk: 'none',
    example: 'return {\n  inject: [\'slots\'],\n  apply(ctx) {\n    ctx.slots.inject(\'settings.models.tab\', () => ctx.slots.register(\n      { name: \'settings.models.tab\', id: \'my-entry\', order: 100, label: \'My entry\' },\n      () => React.createElement(\'div\', null, \'hello\'),\n    ))\n  },\n}',
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-models ModelsSettingsSection id \'models\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-brand-official OfficialBrandMark',
      '@little-whale/ui-brand LittleWhaleMark',
    ],
    replaceRisk: 'shadows-shipped-ui',
  ...
  },
  {
    ...
    occupants: [
      ...
      '@little-whale/ui-brand LittleWhaleName',
    ],
    replaceRisk: 'shadows-shipped-ui',
