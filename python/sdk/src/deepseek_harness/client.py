...
class HarnessConfig:
    """Configuration for launching the local Little Whale SDK runtime."""
...
class HarnessClient:
    """Synchronous JSON-RPC client for the Little Whale SDK runtime over stdio."""
    ...
    def close(self) -> None:
        ...
        try:
            ...
            proc.wait()
        self._proc = None
        self._fail_waiters(self._runtime_closed_error("Little Whale runtime closed"))
            ...
            while True:
                ...
                if deadline is not None:
                    ...
                    if remaining <= 0:
                        ...
                        raise TimeoutError(
                            f"{method} timed out waiting for Little Whale runtime{suffix}"
                        )
    ...
    def _write_message(self, message: JsonObject) -> None:
        ...
        if proc is None or proc.stdin is None:
            raise TransportClosedError("Little Whale runtime is not running")
        try:
            ...
            raise self._runtime_closed_error("Failed to write to Little Whale runtime") from exc
    ...
    def _reader_loop(self) -> None:
        ...
        try:
            ...
            self._fail_waiters(self._runtime_closed_error("Little Whale runtime stdout closed"))
    ...
    def _default_launch_args(self) -> tuple[str, ...]:
        ...
        try:
            ...
            raise FileNotFoundError(
                "Unable to locate the bundled Little Whale SDK runtime. "
