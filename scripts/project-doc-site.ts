...
const REPOSITORY_URL = 'https://github.com/ddonofrio/LittleWhale'
...
/** The single locale group llms.txt lists. */
const llmsTxtLocales: readonly { heading: string; locale: DocsLocale }[] = [{ heading: 'English', locale: 'en' }]
 ...
 * @returns llms.txt content listing the English route tree.
 */
