...
**Balanced:** “Owns the worker realm and its host bridge. Realm initialization is single-shot; disposal terminates the worker and rejects later calls. See the architecture documentation for the protocol rationale.”
...
**Over-trimmed:** “Disposal is documented elsewhere.”

**Balanced:** “Disposal aborts the run and waits for provider quiescence. See the lifecycle documentation for ownership and race handling.”

**Over-detailed:** Repeating promise choreography and rejected ownership models beside every disposer.
...
## Verification contracts retain their coverage

**Over-trimmed:** Deleting the entire Testing section because the implementation has shipped.
...
**Balanced:** “Provider selection is cached for the plugin lifetime; installing or repairing a provider requires reload.” Keep ordinary cleanup in its TODO or package documentation.
